...
/**
 * @file
 * Kuali theme implementation to display a node.
 *
 * Available variables:
	...
	<ul id="home-content-boxes" class="alt">
		<li>
			...
			<div class="content-box-content">
				...
				<p><a href="<?php print $content['field_destination_url']['#items'][0]['safe_value']; ?>" class="button"><?php print $content['field_spotlight_btn_txt']['#items'][0]['safe_value']; ?></a></p>
			</div>
		</li>
	</ul>
</section>